#!/usr/bin/env python3
"""
Generate 20 diverse test recipes to validate the improved pipeline.

These recipes span multiple cuisines and categories to test universality.
"""
...
# 20 diverse recipes with modifications
RECIPES = [
    # 1. Italian Pasta
    generate_recipe(
        "5001",
        ...
        [
            ...
            },
            {
                "username": "PastaLover",
                "rating": 3,
                "text": "Was okay but a bit too rich for me. Maybe I'll try with less cheese next time.",
                "has_modification": False
            },
            {
                "username": "SimpleCook",
                "rating": 5,
                "text": "Followed the recipe exactly and it turned out perfect! No changes needed.",
                "has_modification": False
            },
            {
                "username": "CriticalEater",
                "rating": 2,
                "text": "Didn't work for me. The sauce was too thick and the pasta was overcooked.",
                "has_modification": False
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            "Brown chicken in tagine.",
            "Cook onion and spices.",
            "Add chicken back with stock.",
            "Simmer 45 minutes.",
        ...
        [
            {
                "username": "MoroccanCook",
                "rating": 5,
                "text": "Incredible flavors! Added a splash of chicken stock and a pinch of ras el hanout. Also added a dash of lemon juice and a sprinkle of fresh cilantro.",
                "has_modification": True
            },
            {
                "username": "TagineLover",
                "rating": 4,
                "text": "Used dried apricots instead of olives. Added extra cumin and a pinch of cinnamon. Served over couscous.",
                "has_modification": True
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            "2 cups cooked rice",
            "1 lb beef bulgogi",
            "1 cup spinach, seasoned",
            "1 cup bean sprouts, seasoned",
            "1 carrot, julienned",
        ...
        [
            "Season and cook vegetables separately.",
            "Cook bulgogi.",
        ...
        [
            {
                "username": "KoreanChef",
                "rating": 5,
                "text": "Restaurant quality at home! Added a splash of sesame oil and a pinch of gochugaru. Also added a dash of soy sauce and topped with sesame seeds.",
                "has_modification": True
            },
            {
                "username": "BibimbapLover",
                "rating": 4,
                "text": "Used tofu instead of beef. Added extra vegetables and a drizzle of chili oil. Served with kimchi on the side.",
                "has_modification": True
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            "Simmer beans with smoked meats.",
            "Cook until beans are tender.",
            "Season and finish.",
            "Serve over white rice.",
            "Garnish with orange slices.",
            "Serve with sauteed collard greens."
        ],
        [
            {
                "username": "BrazilianChef",
                "rating": 5,
                "text": "Authentic and delicious! Added a splash of lime juice and a pinch of sea salt. Also added a dash of hot sauce and topped with fresh cilantro.",
                "has_modification": True
            },
            {
                "username": "FeijoadaFan",
                "rating": 4,
                "text": "Used ham hocks instead of pork shoulder. Added extra bay leaves and a pinch of black pepper. Served with farofa.",
                "has_modification": True
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            ...
            "Mix bulgur with meat and spices.",
            "Make filling with meat, onions, nuts.",
        ...
        [
            {
                "username": "LebaneseCook",
                "rating": 5,
                "text": "Perfect kibbeh! Added a splash of lemon juice and a pinch of sumac. Also added a dash of allspice and a sprinkle of fresh mint.",
                "has_modification": True
            },
            {
                "username": "MiddleEasternFan",
                "rating": 4,
                "text": "Baked instead of fried for a lighter version. Added extra pine nuts and a pinch of cumin. Served with tahini sauce.",
                "has_modification": True
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            "Cook onions slowly until browned.",
            "Add berbere and niter kibbeh.",
            "Add chicken and cook.",
            "Add garlic and ginger.",
            "Simmer until chicken is done.",
            "Add eggs and serve with injera."
        ],
        [
            {
                "username": "EthiopianChef",
                "rating": 5,
                "text": "Incredible! Added a splash of lemon juice and a pinch of cardamom. Also added a dash of berbere and topped with fresh cilantro.",
                "has_modification": True
            },
            {
                "username": "SpicyFoodie",
                "rating": 4,
                "text": "Used extra berbere for more heat. Added a splash of water and a pinch of salt. Served with extra injera.",
                "has_modification": True
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            "Make dough with flour, egg, sour cream.",
            "Boil and mash potatoes.",
            "Mix with cheese and caramelized onion.",
            "Roll dough and fill.",
            "Boil pierogi.",
        ...
        [
            {
                "username": "PolishChef",
                "rating": 5,
                "text": "Just like grandma's! Added a pinch of salt and a dash of pepper. Also added a splash of sour cream and topped with fried onions.",
                "has_modification": True
            },
            {
                "username": "DumplingLover",
                "rating": 4,
                "text": "Added bacon and cheddar cheese. Also added a pinch of garlic powder and a drizzle of melted butter.",
                "has_modification": True
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            ...
            "1 cilantro bunch",
            "1 tsp salt",
            "Corn and sweet potato for serving"
        ],
        [
            "Marinate fish in lime juice.",
            "Let cure for 20 minutes.",
            "Add onion, jalapeno, cilantro.",
            "Season with salt.",
            "Serve immediately.",
            "Accompany with corn and sweet potato."
        ],
        [
            {
                "username": "PeruvianChef",
                "rating": 5,
                "text": "Fresh and perfect! Added a splash of lime juice and a pinch of chili powder. Also added a dash of hot sauce and topped with extra cilantro.",
                "has_modification": True
            },
            {
                "username": "CevicheLover",
                "rating": 4,
                "text": "Added shrimp and scallops. Added extra jalapeno and a pinch of cumin. Served with plantain chips.",
                "has_modification": True
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            ...
            "Repeat layers.",
            "Cut before baking.",
            "Make syrup and pour hot over cold baklava."
        ],
        [
            {
                "username": "TurkishChef",
                "rating": 5,
                "text": "Perfect baklava! Added a splash of lemon juice and a pinch of cardamom to the syrup. Also added a dash of rose water and topped with extra pistachios.",
                "has_modification": True
            },
            {
                "username": "DessertLover",
                "rating": 4,
                "text": "Used walnuts instead of pistachios. Added extra cinnamon and a pinch of clove. Served with vanilla ice cream.",
                "has_modification": True
            }
        ]
    ),
    ...
    generate_recipe(
        ...
        [
            "Blend peppers, onion, garlic, ginger.",
            "Add spices and marinade chicken.",
            "Let marinate 4 hours.",
            "Grill over charcoal.",
        ...
        [
            {
                "username": "JamaicanChef",
                "rating": 5,
                "text": "Authentic heat! Added a splash of soy sauce and a pinch of nutmeg. Also added a dash of lime juice and topped with green onions.",
                "has_modification": True
            },
            {
                "username": "SpicyFoodie",
                "rating": 4,
                "text": "Reduced scotch bonnet peppers for less heat. Added extra brown sugar and a pinch of paprika. Served with mango salsa.",
                "has_modification": True
            }
        ]
    ),

    # 20. Australian Pavlova
    generate_recipe(
        "5020",
        "Pavlova",
        "Australian",
        ...
        [
            ...
            "Gradually add sugar.",
            "Fold in vinegar, cornstarch, vanilla.",
            "Bake at low heat for 1 hour.",
            "Cool in oven.",
            "Top with whipped cream and fruits."
        ],
        [
            {
                "username": "AustralianChef",
                "rating": 5,
                "text": "Perfect pavlova! Added a splash of vanilla and a pinch of salt. Also added a dash of lemon zest and topped with passion fruit.",
                "has_modification": True
            },
            {
                "username": "DessertLover",
                "rating": 4,
                "text": "Used berries and kiwi for topping. Added extra vanilla and a pinch of cream of tartar. Served with mango coulis.",
                "has_modification": True
            }
        ]
    ),
...
def main():
    ...
    print("=" * 80)
    print("Generating 20 Diverse Test Recipes")
    print("=" * 80)
    ...
    print()
    total_reviews = sum(len(r['reviews']) for r in RECIPES)
    total_modifications = sum(sum(1 for r in recipe['reviews'] if r['has_modification']) for recipe in RECIPES)

    print(f"Total Reviews: {total_reviews}")
    print(f"Total with Modifications: {total_modifications}")
    print(f"Average per Recipe: {total_reviews/len(RECIPES):.1f}")
